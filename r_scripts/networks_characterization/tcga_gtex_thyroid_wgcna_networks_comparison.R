...
pdf(file="./plots/wgcna_networks/tcga_thyroid_tumours_wgcna_networks_comparison_malesVSfemales2.pdf", w=6, h=6)
...
pdf(file="./plots/wgcna_networks/gtex_thyroid_wgcna_networks_comparison_malesVSfemales2.pdf", w=6, h=6)

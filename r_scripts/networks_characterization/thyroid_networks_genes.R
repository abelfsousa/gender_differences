...
thyroid_normal_gender_diff_networks <- read_tsv("./files/thyroid_normal_gender_diff_networks.txt")
...
males_tumour_modules <- tibble(genes_ens = colnames(males_tumour)) %>%
  ...
  filter(moduleL != "grey") %>%
  inner_join(thyroid_tumour_gender_diff_networks %>% filter(network == "males") %>% dplyr::select(-network), by=c("moduleL" = "module")) %>%
  arrange(moduleL)
write.table(males_tumour_modules, "./files/thyroid_males_tumour_modules.txt", quote=F, sep="\t", row.names=F)
...
females_tumour_modules <- tibble(genes_ens = colnames(females_tumour)) %>%
  ...
  filter(moduleL != "grey") %>%
  inner_join(thyroid_tumour_gender_diff_networks %>% filter(network == "females") %>% dplyr::select(-network), by=c("moduleL" = "module")) %>%
  arrange(moduleL)
write.table(females_tumour_modules, "./files/thyroid_females_tumour_modules.txt", quote=F, sep="\t", row.names=F)
...
males_normal_modules <- tibble(genes_ens = colnames(males_normal)) %>%
  ...
  filter(moduleL != "grey") %>%
  inner_join(thyroid_normal_gender_diff_networks %>% filter(network == "males") %>% dplyr::select(-network), by=c("moduleL" = "module")) %>%
  arrange(moduleL)
write.table(males_normal_modules, "./files/thyroid_males_normal_modules.txt", quote=F, sep="\t", row.names=F)
...
females_normal_modules <- tibble(genes_ens = colnames(females_normal)) %>%
  ...
  filter(moduleL != "grey") %>%
  inner_join(thyroid_normal_gender_diff_networks %>% filter(network == "females") %>% dplyr::select(-network), by=c("moduleL" = "module")) %>%
  arrange(moduleL)
write.table(females_normal_modules, "./files/thyroid_females_normal_modules.txt", quote=F, sep="\t", row.names=F)

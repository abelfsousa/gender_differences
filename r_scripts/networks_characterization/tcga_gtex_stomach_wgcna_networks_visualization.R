...
stomach_correlations <- data.frame(
...
stomach_correlations_plot <- ggplot(data=stomach_correlations, mapping=aes(x=data, y=pearson, fill=data)) +
...
ggsave("stomach_correlations_plot.png", plot=stomach_correlations_plot, path="./plots/")
unlink("stomach_correlations_plot.png")


stomach_correlations_densityplot <- ggplot(data=stomach_correlations, mapping=aes(x=pearson, fill=data, colour=data)) +
...
ggsave("stomach_correlations_densityplot.png", plot=stomach_correlations_densityplot, path="./plots/")
unlink("stomach_correlations_densityplot.png")
...
png(file="./plots/stomach_males_tumour_wgcna_modules_heatmap.png")
...
png(file="./plots/stomach_males_normal_wgcna_modules_heatmap.png")
...
png(file="./plots/stomach_females_tumour_wgcna_modules_heatmap.png")
...
png(file="./plots/stomach_females_normal_wgcna_modules_heatmap.png")

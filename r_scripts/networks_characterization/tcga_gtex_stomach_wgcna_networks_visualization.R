...
png(file="./plots/wgcna_networks/stomach_males_tumour_wgcna_modules_tomplot.png")
TOMplot( diss_mat1^4, hier_clust1, as.character(colors1[restGenes1]), main = "" )
dev.off()
...
png(file="./plots/wgcna_networks/stomach_males_normal_wgcna_modules_tomplot.png")
TOMplot( diss_mat2^4, hier_clust2, as.character(colors2[restGenes2]), main = "" )
dev.off()
...
png(file="./plots/wgcna_networks/stomach_females_tumour_wgcna_modules_tomplot.png")
TOMplot( diss_mat3^4, hier_clust3, as.character(colors3[restGenes3]), main = "" )
dev.off()
...
png(file="./plots/wgcna_networks/stomach_females_normal_wgcna_modules_tomplot.png")
TOMplot( diss_mat4^4, hier_clust4, as.character(colors4[restGenes4]), main = "" )
dev.off()

...
diff_expr_normal_table <- read_tsv("./files/diff_expr_thyroid_normal_tcga_maleVSfemale_limma.txt")
...
males_females_signf_degs_venn <- draw.pairwise.venn(
    ...
    cex = rep(1.5, 3),
    cat.cex = rep(1.5, 2))
ggsave(filename="thyroid_tumour_normal_signf_degs_venn2.png", plot=males_females_signf_degs_venn, path = "./plots/diff_expression_maleVSfemale/", width=3, height=3)
...
ggsave(filename="diff_expr_thyroid_tumour_tcga_maleVSfemale.png", plot=diff_expr_tumour_table_vp, path = "./plots/diff_expression_maleVSfemale/", width=6, height=7)
unlink("diff_expr_thyroid_tumour_tcga_maleVSfemale.png")
...
ggsave(filename="diff_expr_thyroid_normal_tcga_maleVSfemale.png", plot=diff_expr_normal_table_vp, path = "./plots/diff_expression_maleVSfemale/", width=6, height=7)
unlink("diff_expr_thyroid_normal_tcga_maleVSfemale.png")

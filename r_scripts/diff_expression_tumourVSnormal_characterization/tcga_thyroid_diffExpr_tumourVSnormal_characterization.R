...
ggsave(filename="thyroid_common_degs_enr_barplot.png", plot=common_degs_enr_barplot, path="./plots/diff_expression_tumourVSnormal/", width = 16, height = 8)
ggsave(filename="thyroid_common_degs_enr_barplot.pdf", plot=common_degs_enr_barplot, path="./plots/diff_expression_tumourVSnormal/", width = 16, height = 8)
...
female_specific_degs_enr_barplot <- female_specific_degs_enr_tab %>%
  ...
  scale_fill_viridis(option="D", name="") +
  scale_y_continuous(name = "Adjusted P-value (-log10)")
ggsave(filename="thyroid_female_specific_degs_enr_barplot.png", plot=female_specific_degs_enr_barplot, path="./plots/diff_expression_tumourVSnormal/", width = 10, height = 10)
ggsave(filename="thyroid_female_specific_degs_enr_barplot.pdf", plot=female_specific_degs_enr_barplot, path="./plots/diff_expression_tumourVSnormal/", width = 10, height = 10)
...
male_specific_degs_enr_barplot <- male_specific_degs_enr_tab %>%
  ...
  scale_fill_viridis(option="D", name="") +
  scale_y_continuous(name = "Adjusted P-value (-log10)")
ggsave(filename="thyroid_male_specific_degs_enr_barplot.png", plot=male_specific_degs_enr_barplot, path="./plots/diff_expression_tumourVSnormal/", width = 16, height = 8)
ggsave(filename="thyroid_male_specific_degs_enr_barplot.pdf", plot=male_specific_degs_enr_barplot, path="./plots/diff_expression_tumourVSnormal/", width = 16, height = 8)

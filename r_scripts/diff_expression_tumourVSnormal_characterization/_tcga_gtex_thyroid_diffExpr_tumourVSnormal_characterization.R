...
# load datasets
diff_expr_males_table <- read_tsv("./files/diff_expr_thyroid_males_tcga_gtex_tumourVSnormal.txt")
diff_expr_females_table <- read_tsv("./files/diff_expr_thyroid_females_tcga_gtex_tumourVSnormal.txt")
...
ggsave(filename="thyroid_males_females_signf_degs_bp.png", plot=males_females_signf_degs_bp, path = "./plots/")
...
diff_expr_males_vp <- ggplot( data = diff_expr_males_table, mapping = aes(x=logFC, y=-log10(adj.P.Val), colour=state, fill=fdr) ) +
    ...
    theme(axis.title = element_text(colour="black", size=15),
        ...
        plot.title=element_text(colour="black", size=15)) +
    labs(x = "logFC", y = "FDR (-log10)", title="Thyroid - Males")
ggsave(filename="diff_expr_thyroid_males_tcga_gtex_tumourVSnormal.png", plot=diff_expr_males_vp, path = "./plots/")
unlink("diff_expr_thyroid_males_tcga_gtex_tumourVSnormal.png")
...
diff_expr_females_vp <- ggplot( data = diff_expr_females_table, mapping = aes(x=logFC, y=-log10(adj.P.Val), colour=state, fill=fdr) ) +
    ...
    theme(axis.title = element_text(colour="black", size=15),
        ...
        legend.title=element_text(colour="black", size=15),
        plot.title=element_text(colour="black", size=15)) +
    labs(x = "logFC", y = "FDR (-log10)", title="Thyroid - Females")
ggsave(filename="diff_expr_thyroid_females_tcga_gtex_tumourVSnormal.png", plot=diff_expr_females_vp, path = "./plots/")
unlink("diff_expr_thyroid_females_tcga_gtex_tumourVSnormal.png")
...
ggsave(filename="thyroid_common_degs_go_dot.png", plot=common_degs_go_dot, path = "./plots/", width=8)
unlink("thyroid_common_degs_go_dot.png")
...
ggsave(filename="thyroid_common_degs_keggPath_dot.png", plot=common_degs_keggPath_dot, path = "./plots/", width=8)
unlink("thyroid_common_degs_keggPath_dot.png")
...
ggsave(filename="thyroid_femaleSpecific_degs_go_dot.png", plot=femaleSpecific_degs_go_dot, path = "./plots/", width=11)
unlink("thyroid_femaleSpecific_degs_go_dot.png")
...
ggsave(filename="thyroid_femaleSpecific_degs_keggPath_dot.png", plot=femaleSpecific_degs_keggPath_dot, path = "./plots/", width=7)
unlink("thyroid_femaleSpecific_degs_keggPath_dot.png")
...
ggsave(filename="thyroid_maleSpecific_degs_go_dot.png", plot=maleSpecific_degs_go_dot, path = "./plots/", width=11)
unlink("thyroid_maleSpecific_degs_go_dot.png")
...
ggsave(filename="thyroid_maleSpecific_degs_keggPath_dot.png", plot=maleSpecific_degs_keggPath_dot, path = "./plots/", width=7)
unlink("thyroid_maleSpecific_degs_keggPath_dot.png")
...
save(list=ls(), file="r_workspaces/tcga_gtex_thyroid_diffExpr_tumourVSnormal_characterization.RData")

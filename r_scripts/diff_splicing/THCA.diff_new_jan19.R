...
design.normal.MvsF <- model.matrix(~ race + ethnicity + age_at_diagnosis + portion + gender, allData.THCA$exon$counts$normal$clin)
...
#               gene geneName chrom NExons      P.Value        FDR
# 123234 WDR74|54663    WDR74 chr11     12 2.207097e-06 0.02372188
# 1411    LZIC|84328     LZIC  chr1     10 7.207190e-06 0.03284909
# 83133    CHN2|1124     CHN2  chr7     18 9.168893e-06 0.03284909


png("THCA.normal.MvsF.limma.WDR74.png", width=800, height =650)
par(mar=c(10,5.1, 4.1, 2.1))
plotSplice(THCA.normal.MvsF.limma$diff.ex.usage[[3]], geneid="WDR74", genecol="geneName")
dev.off()
...
design.female.TvsN <-model.matrix(~ race + ethnicity + age_at_diagnosis + tss + portion + plate + sample_type_id, exon_counts_tumour_normal_female_clin)
...
#               gene geneName chrom NExons      P.Value        FDR
# 150719  SNW1|22938     SNW1 chr14     13 6.477088e-06 0.04307345
# 4083   DHDDS|79947    DHDDS  chr1      9 8.544962e-06 0.04307345
# 166718  NDE1|54820     NDE1 chr16     11 1.202273e-05 0.04307345
...
png("THCA.female.TvsN.limma.NDE1.png", width=800, height =650)
par(mar=c(10,5.1, 4.1, 2.1))
plotSplice(THCA.female.TvsN.limma$diff.ex.usage[[3]], geneid="NDE1", genecol="geneName")
dev.off()
...
design.male.TvsN <-model.matrix(~ race + ethnicity + age_at_diagnosis +  tss + portion + plate + sample_type, exon_counts_tumour_normal_male_clin)
...
#               gene geneName chrom NExons      P.Value          FDR
# 191475  MLLT1|4298    MLLT1 chr19     12 2.797179e-11 3.006408e-07
# 218148 MAGED1|9500   MAGED1  chrX     15 5.803515e-11 3.118809e-07
# 145086 DZIP1|22873    DZIP1 chr13     24 1.249713e-09 4.477305e-06
# 223256 TMLHE|55217    TMLHE  chrX      9 1.499822e-05 4.030022e-02
...
png("THCA.male.TvsN.limma.TMLHE.png", width=800, height =650)
par(mar=c(10,5.1, 4.1, 2.1))
plotSplice(THCA.male.TvsN.limma$diff.ex.usage[[3]], geneid="TMLHE", genecol="geneName")
dev.off()

save(list=ls(), file="THCA.limma.spl_new.RData")

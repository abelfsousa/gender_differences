...
stomach_gtex_fpkm <- read_tsv("./files/stomach_tcga_gtex_fpkm_GTEX_regressed_out_COVARS.txt") %>% column_to_rownames(var = "gene")
...
males_normal <- stomach_gtex_fpkm[, colnames(stomach_gtex_fpkm) %in% rownames(stomach_tcga_gtex_meta[(stomach_tcga_gtex_meta$gender == "male" & stomach_tcga_gtex_meta$sample_type == "GTEx"), ])]
...
females_normal <- stomach_gtex_fpkm[, colnames(stomach_gtex_fpkm) %in% rownames(stomach_tcga_gtex_meta[(stomach_tcga_gtex_meta$gender == "female" & stomach_tcga_gtex_meta$sample_type == "GTEx"), ])]

...
males_normal <- thyroid_tcga_gtex_fpkm[, colnames(thyroid_tcga_gtex_fpkm) %in% rownames(thyroid_tcga_gtex_meta[(thyroid_tcga_gtex_meta$gender == "male" & thyroid_tcga_gtex_meta$sample_type == "GTEx"), ])]
...
females_normal <- thyroid_tcga_gtex_fpkm[, colnames(thyroid_tcga_gtex_fpkm) %in% rownames(thyroid_tcga_gtex_meta[(thyroid_tcga_gtex_meta$gender == "female" & thyroid_tcga_gtex_meta$sample_type == "GTEx"), ])]
...
cutTree_females_normal <- cutreeStatic(hclust(dist(females_normal), method = "average"), cutHeight = 75, minSize = 10)
